...
JS_FILES=(common compass map-initialization tips-interactions ui-interactions account stats-chart best-operator rollout coverage-subscribe embed-coverage-loader api-demo)
