...
TRANSLATIONS = {
    ...
    'Strong coverage here': 'Bardzo dobry zasięg w tym miejscu',
    'Good coverage here': 'Dobry zasięg w tym miejscu',
    'Moderate coverage here': 'Umiarkowany zasięg w tym miejscu',
    'Weak coverage here': 'Słaby zasięg w tym miejscu',
    'Nearest mast:': 'Najbliższy maszt:',
    '5G in range': '5G w zasięgu',
    'none in range': 'brak w zasięgu',
    'Estimate from mast distance and UKE permit data — not a signal measurement.':
