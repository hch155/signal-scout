...
TRANSLATIONS = {
    ...
    'Patchy signal': 'Nierówny zasięg',
    'Weak signal': 'Słaby sygnał',
    'Nearest mast': 'Najbliższy maszt',
    'in range': 'w zasięgu',
    'Estimated from mast distance and UKE data. Not a measured signal.': 'Szacowane na podstawie odległości od masztu i danych UKE. To nie zmierzony sygnał.',
    'Stations': 'Stacje',
    'Avg Dist': 'Śr. odl.',
    'Nearest': 'Najbliższa',
