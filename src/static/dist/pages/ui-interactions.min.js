updateDynamicContent();let mymap=L.map("mapid").setView([52.231,21.004],7),lightTileLayer=L.tileLayer("https://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png",{attribution:'&copy; <a href="www.openstreetmap.org/copyright">OpenStreetMap contributors</a>'}).addTo(mymap),darkTileLayer=L.tileLayer("https://tiles.stadiamaps.com/tiles/alidade_smooth_dark/{z}/{x}/{y}{r}.png",{attribution:'&copy; <a href="https://www.stadiamaps.com/" target="_blank">Stadia Maps</a> &copy; <a href="https://openmaptiles.org/" target="_blank">OpenMapTiles</a> &copy; <a href="https://www.openstreetmap.org/copyright">OpenStreetMap</a> contributors'}),greenIcon=new L.Icon({iconUrl:"static/css/images/marker-icon-green.png",shadowUrl:"static/css/images/marker-shadow.png",iconSize:[25,41],iconAnchor:[12,41],popupAnchor:[1,-34],shadowSize:[41,41]}),providerColors={"P4 Sp. z o.o.":"violet","Orange Polska S.A.":"orange","T-Mobile Polska S.A.":"red","POLKOMTEL Sp. z o.o.":"blue"},initialFilters=()=>({lat:null,lng:null,limit:null,maxDistance:null,serviceProvider:[],frequencyBands:[],mode:"all"}),locationSetInitially=!1,currentFilters=initialFilters(),stationMarkers=[],marker,userSubmittedLocation=null,countryBoundaries,isFirstClick=!0,currentBand="low",frequencyRanges={high:[200,500,1e3,1500],mid:[300,750,1500,2e3],low:[500,1500,3e3,5e3]},frequencyRangecolors=["green","yellow","orange","red"];function setupTouchInteraction(e){let t=!1;var n=()=>t=!0,n=(e.on("touchstart",n),e.on("touchmove",n),e.on("touchend",()=>setTimeout(()=>t=!1,500)),e.on("click",function(e){t&&e.originalEvent.preventDefault()}),e.doubleClickZoom.disable(),document.querySelector(".leaflet-control-zoom"));n&&(L.DomEvent.disableClickPropagation(n),L.DomEvent.on(n,"touchstart touchend",L.DomEvent.stopPropagation))}window.onload=hideSidebar,globalFetch("/static/PL-administrative-boundaries.json").then(e=>{countryBoundaries=L.geoJson(e,{style:function(e){return{fillColor:"transparent",fill:!1,color:"#4a90e2",weight:2}}}).addTo(mymap)}),mymap.on("click",function(e){if(e.originalEvent&&e.originalEvent.target&&e.originalEvent.target.closest(".leaflet-control"))return;var e=e.latlng,t=e.lat,e=e.lng;marker&&mymap.removeLayer(marker),marker=L.marker([t,e],{icon:greenIcon}).addTo(mymap),currentFilters.lat=t,currentFilters.lng=e,isFirstClick?(sendLocation(t,e),isFirstClick=!1):fetchStations()}),setupTouchInteraction(mymap);let gpsButton=L.control({position:"topleft"}),frequencyRangeLegend=(gpsButton.onAdd=function(e){var t=L.DomUtil.create("div","gps-location-control");return t.innerHTML=`
        <button id="useMyLocationBtn" title="Use My Location" class="map-control-btn">
            <span class="control-icon">📍</span>
            <span class="control-label">GPS</span>
        </button>
    `,L.DomEvent.on(t,"click",function(e){L.DomEvent.stop(e),document.getElementById("useMyLocationBtn").classList.add("collapsed"),requestAndSendGPSLocation()}),t},gpsButton.addTo(mymap),L.control({position:"topleft"})),btsCountControl=(frequencyRangeLegend.onAdd=function(e){let o=L.DomUtil.create("div","gps-location-control"),t=(o.style.cursor="grab",o.style.userSelect="none",o.style.position="absolute",o.style.top="112px",o.style.left="0px",L.DomUtil.create("button","map-control-btn",o)),n=(t.id="toggleFrequencyRangeLegendBtn",t.title="Signal Range Legend",t.innerHTML=`
            <span class="control-icon text-green-500 text-lg">◎</span>
            <span class="control-label">Range</span>
        `,L.DomUtil.create("div","frequency-range-container bg-white p-1 rounded shadow text-black dark:bg-black dark:text-white w-76 accent-blue-500 dark:accent-gray-400",o)),i=(n.innerHTML=`
